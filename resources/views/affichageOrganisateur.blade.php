...
<!DOCTYPE html>
<html lang="en">
<!-- Mirrored from demos.creative-tim.com/soft-ui-dashboard-pro/pages/dashboards/automotive.html by HTTrack Website Copier/3.x [XR&CO'2014], Fri, 04 Aug 2023 06:27:25 GMT -->
<!-- Added by HTTrack -->
...
<body class="g-sidenav-show  bg-gray-100">
          ...
          <div class="collapse  show " id="dashboardsExamples">
            <ul class="nav ms-4 ps-3">
              ...
              <li class="nav-item active">
                <a class="nav-link active" href="automotive.html">
              ...
              <div class="row">
                ...
                <div class="col-lg-6 col-12 text-center">
                  ...
                  <div class="d-flex align-items-center">
                    ...
                    <h2 class="text-white ms-2 me-auto">70
              ...
              <div class="row">
                <div class="col-8">
                  <div class="numbers">
                    ...
                    <h5 class="text-white font-weight-bolder mb-0">56 Km/h</h5>
                  </div>
                </div>
                <div class="col-4 text-end">
                  <div class="icon icon-shape bg-white shadow text-center border-radius-md">
          ...
          <div class="card bg-gradient-dark">
            <div class="card-header bg-transparent">
              ...
              <div class="row">
                ...
                <div class="col-lg-4 col-md-6 col-12">
                  <div class="d-flex align-items-center position-relative">
                    <h3 class="text-white mb-1 ms-auto">2.4
                ...
                <div class="col-lg-4 col-md-6 col-12 ms-lg-auto">
                  <div class="d-flex align-items-center">
                    <h3 class="text-white mb-1 ms-lg-auto">6.3
                      <small class="align-top text-sm">Km</small>
                    </h3>
              ...
              <div class="row">
                <div class="col-lg-4 col-md-6 col-12">
                  <div class="d-flex align-items-center">
                    ...
                    <div class="px-3">
                      <p class="text-white text-sm font-weight-bold mb-0">You're Mines Still (feat Drake)</p>
                      <p class="text-white text-xs mb-2 opacity-8">Yung Bleu - Hip-Hop</p>
                    </div>
                  </div>
                </div>
  ...
  // Initialize the map and assign it to a variable for later use
    ...
    var tiles = new L.tileLayer('../../../../%7bs%7d.basemaps.cartocdn.com/dark_all/%7bz%7d/%7bx%7d/%7by%7d%7br%7d.png', {
  ...
  <script defer src="https://static.cloudflareinsights.com/beacon.min.js/v8b253dfea2ab4077af8c6f58422dfbfd1689876627854" integrity="sha512-bjgnUKX4azu3dLTVtie9u6TKqgx29RBwfj3QXYt5EKfWM/9hPSAI/4qcV5NACjwAo8UtTeWefx6Zq5PHcMm7Tg==" data-cf-beacon='{"rayId":"7f14bb490d47008b","version":"2023.7.0","r":1,"b":1,"token":"1b7cbb72744b40c580f8633c6b62637e","si":100}' crossorigin="anonymous"></script>
</body>
</html>
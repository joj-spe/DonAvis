<!DOCTYPE html>
<html lang="en">
<!-- Mirrored from demos.creative-tim.com/soft-ui-dashboard-pro/pages/pages/account/invoice.html by HTTrack Website Copier/3.x [XR&CO'2014], Fri, 04 Aug 2023 06:27:53 GMT -->
<!-- Added by HTTrack -->
...
<body class="g-sidenav-show bg-gray-100">
        ...
        <div class="col-lg-4 col-sm-8">
          <div class="nav-wrapper position-relative end-0">
            <ul class="nav nav-pills nav-fill p-1" role="tablist">
              <li class="nav-item">
                <a class="nav-link mb-0 px-0 py-1 active " data-bs-toggle="tab" href="../../../examples/pages/account/settings.html" role="tab" aria-selected="true">Messages</a>
              </li>
              <li class="nav-item">
              ...
              <li class="nav-item">
                <a class="nav-link mb-0 px-0 py-1  active " data-bs-toggle="tab" href="../../../examples/pages/account/invoice.html" role="tab" aria-selected="false">Notifications</a>
              </li>
              <li class="nav-item">
    ...
    <div class="container-fluid my-3 py-3">
      <div class="row">
        <div class="col-md-8 col-sm-10 mx-auto">
          <form class="" action="https://demos.creative-tim.com/soft-ui-dashboard-pro/pages/pages/account/index.html" method="post">
              ...
              <div class="card-header text-center">
                <div class="row justify-content-between">
                  ...
                  <div class="col-lg-3 col-md-7 text-md-end text-start mt-5">
                    ...
                    <p class="text-secondary">4006 Locust View Drive
                      <br>San Francisco CA
                      <br>California</p>
                  </div>
                </div>
              ...
              <div class="card-footer mt-md-5 mt-4">
                <div class="row">
                  <div class="col-lg-5 text-left">
                    ...
                    <h6 class="text-secondary mb-0">email:
                      <span class="text-dark">
                        <a href="https://demos.creative-tim.com/cdn-cgi/l/email-protection" class="__cf_email__" data-cfemail="e2919792928d9096a281908783968b9487cf968b8fcc818d8f">[email&#160;protected]</a>
                      </span>
                    </h6>
                  </div>
  ...
  <script defer src="https://static.cloudflareinsights.com/beacon.min.js/v8b253dfea2ab4077af8c6f58422dfbfd1689876627854" integrity="sha512-bjgnUKX4azu3dLTVtie9u6TKqgx29RBwfj3QXYt5EKfWM/9hPSAI/4qcV5NACjwAo8UtTeWefx6Zq5PHcMm7Tg==" data-cf-beacon='{"rayId":"7f14bb5e0b9c0a55","version":"2023.7.0","r":1,"b":1,"token":"1b7cbb72744b40c580f8633c6b62637e","si":100}' crossorigin="anonymous"></script>
</body>

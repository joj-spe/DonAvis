<!DOCTYPE html>
<html lang="en">
<!-- Mirrored from demos.creative-tim.com/soft-ui-dashboard-pro/pages/pages/projects/general.html by HTTrack Website Copier/3.x [XR&CO'2014], Fri, 04 Aug 2023 06:27:54 GMT -->
<!-- Added by HTTrack -->
...
<body class="g-sidenav-show  bg-gray-100">
            ...
            <ul class="nav ms-4 ps-3">
              ...
              <li class="nav-item ">
                ...
                <div class="collapse show" id="projectsExample">
                  <ul class="nav nav-sm flex-column">
                    <li class="nav-item">
                      <a class="nav-link active" href="general.html">
                    ...
                    <li class="nav-item">
                      <a class="nav-link " href="new-project.html">
                        <span class="sidenav-mini-icon text-xs">N</span>
          ...
          <div class="row">
            <div class="col-lg-4 col-12">
              <div class="card card-background card-background-mask-info h-100 tilt" data-tilt="" style="will-change: transform; transform: perspective(1000px) rotateX(0deg) rotateY(0deg) scale3d(1, 1, 1);">
                <div class="full-background" style="background-image: url('../../../assets/img/curved-images/white-curved.html')">
                </div>
                  ...
                  <div class="d-flex">
                    ...
                    <div class="ms-3">
                      <div class="numbers">
                        ...
                        <h5 class="font-weight-bolder mb-0">9,600
                  ...
                  <div class="d-flex">
                    ...
                    <div class="ms-3">
                      <div class="numbers">
                        ...
                        <h5 class="font-weight-bolder mb-0">2,300
                  ...
                  <div class="d-flex">
                    ...
                    <div class="ms-3">
                      <div class="numbers">
                        ...
                        <h5 class="font-weight-bolder mb-0">348
          ...
          <div class="card">
            ...
            <div class="card-body p-3 pt-1">
              ...
              <div class="d-flex bg-gray-100 border-radius-lg p-3">
                <h4 class="my-auto">
                  <span class="text-secondary text-sm me-1">$</span>3,000
        ...
        <div class="col-lg-4 col-12 mt-4 mt-lg-0">
          <div class="card overflow-hidden">
            ...
            <div class="card-body mt-3 p-0">
              <div class="chart">
                <canvas id="chart-line" class="chart-canvas" height="100">
                </canvas>
              </div>
            </div>
          </div>
              ...
              <div class="row">
                <div class="col-lg-5">
                  <div class="d-flex">
                    ...
                    <div class="ms-3">
                      ...
                      <h5 class="font-weight-bolder mb-0">115</h5>
                    </div>
                  </div>
                ...
                <div class="col-lg-7 my-auto">
                  <div class="chart ms-auto">
                    <canvas id="chart-bar" class="chart-canvas" height="150">
                    </canvas>
                  </div>
                </div>
              </div>
  ...
  <script defer src="https://static.cloudflareinsights.com/beacon.min.js/v8b253dfea2ab4077af8c6f58422dfbfd1689876627854" integrity="sha512-bjgnUKX4azu3dLTVtie9u6TKqgx29RBwfj3QXYt5EKfWM/9hPSAI/4qcV5NACjwAo8UtTeWefx6Zq5PHcMm7Tg==" data-cf-beacon='{"rayId":"7f14bb61d95a0a55","version":"2023.7.0","r":1,"b":1,"token":"1b7cbb72744b40c580f8633c6b62637e","si":100}' crossorigin="anonymous"></script>
</body>

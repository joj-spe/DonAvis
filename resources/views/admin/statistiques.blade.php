                  ...
                  <div class="row">
                    <div class="col-8">
                      <div class="numbers">
                        ...
                        <h5 class="font-weight-bolder mb-0">$53,000
                  ...
                  <div class="row">
                    <div class="col-8">
                      <div class="numbers">
                        ...
                        <h5 class="font-weight-bolder mb-0">+3,462
                  ...
                  <div class="row">
                    <div class="col-8">
                      <div class="numbers">
                        ...
                        <h5 class="font-weight-bolder mb-0">$103,430
          ...
          <div class="card z-index-2">
            <div class="card-body p-3">
              ...
              <p class="text-sm ms-2">(
                <span class="font-weight-bolder">+23%</span>) than last week</p>
          ...
          <div class="card z-index-2">
            <div class="card-header pb-0">
              ...
              <p class="text-sm">
                ...
                <span class="font-weight-bold">4% more</span>in 2021</p>
            </div>
            <div class="card-body p-3">
              <div class="chart">
      ...
      <div class="row">
        <div class="col-12">
          <div id="globe" class="position-absolute end-0 top-10 mt-sm-3 mt-7 me-lg-7">
            <canvas width="700" height="600" class="w-lg-100 h-lg-100 w-75 h-75 me-lg-0 me-n10 mt-lg-5">
            </canvas>
          </div>
        </div>
      </div>

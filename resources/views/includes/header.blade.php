    ...
    <div class="btn btn-link btn-sm text-white order-1 order-sm-0" id="sidebarToggle">
        <div class="menu-bar-icon">
            <svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink"
                preserveAspectRatio="xMidYMid" width="18" height="14" class="header-icon"
                viewBox="0 0 18 14">
                <path
                    d="M17.000,-0.000 C17.552,-0.000 18.000,0.448 18.000,1.000 C18.000,1.552 17.552,2.000 17.000,2.000 L1.000,2.000 C0.448,2.000 -0.000,1.552 -0.000,1.000 C-0.000,0.448 0.448,-0.000 1.000,-0.000 L17.000,-0.000 ZM17.000,6.000 C17.552,6.000 18.000,6.447 18.000,7.000 C18.000,7.552 17.552,8.000 17.000,8.000 L1.000,8.000 C0.448,8.000 -0.000,7.552 -0.000,7.000 C-0.000,6.447 0.448,6.000 1.000,6.000 L17.000,6.000 ZM17.000,12.000 C17.552,12.000 18.000,12.448 18.000,13.000 C18.000,13.552 17.552,14.000 17.000,14.000 L1.000,14.000 C0.448,14.000 -0.000,13.552 -0.000,13.000 C-0.000,12.448 0.448,12.000 1.000,12.000 L17.000,12.000 Z">
                </path>
            </svg>
        </div>
    </div>
...
<div class="col-md-5 col-xs-12 p-left  p-right">
    <div class="searching">
        <form>
            <button type="submit">
                <svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink"
                    preserveAspectRatio="xMidYMid" width="19" height="18" class="header-icon"
                    viewBox="0 0 19 18">
                    <path
                        d="M14.720,12.516 L18.658,16.455 C18.993,16.790 18.993,17.332 18.658,17.667 C18.324,18.001 17.781,18.001 17.447,17.667 L13.508,13.728 C12.189,14.783 10.516,15.414 8.695,15.414 C4.436,15.414 0.984,11.962 0.984,7.703 C0.984,3.445 4.436,-0.007 8.695,-0.007 C12.954,-0.007 16.406,3.445 16.406,7.703 C16.406,9.524 15.775,11.197 14.720,12.516 L14.720,12.516 ZM8.695,13.701 C12.007,13.701 14.692,11.016 14.692,7.703 C14.692,4.391 12.007,1.706 8.695,1.706 C5.383,1.706 2.698,4.391 2.698,7.703 C2.698,11.016 5.383,13.701 8.695,13.701 Z">
                    </path>
                </svg>
            </button>
...
<div class="col-md-5 col-xs-12 p-left p-right">
            ...
            <li class="popup dropdown">
                ...
                <div class="dropdown-menu msg-noti-dropdown">
                    <ul>
                        ...
                        <li>
                            <div class="dropdown-btn-mn">
                                <button onclick="window.location.href = '#';">View All
    ...
    <div class="dropdown login">
        <div class="account-dt dropdown-toggle-no-caret" data-toggle="dropdown" aria-haspopup="true"
